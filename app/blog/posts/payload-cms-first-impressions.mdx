...
I still don't have even close to a full understanding of this CMS so I will go back to the original tutorial via JSM, since I only went through the first 30 minuets of it so far, and I'm going to rewatch the first 30 minuetse, and blog the process as I go
