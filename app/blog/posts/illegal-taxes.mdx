...
- **Education**: $14.4 billion (57.1%), which covers K-12 schooling and supplemental English instruction.
- **Healthcare**: $4 billion (15.9%), encompassing emergency medical services and Medicaid-related expenses.
- **Law Enforcement**: $4.4 billion (17.6%), covering policing, judicial costs, and incarceration.
- **Public Assistance**: $791.6 million (3%), which includes welfare programs and school meal subsidies.
- **General Government Services**: $1.6 billion (6.3%), for public services such as parks, road maintenance, and fire departments.
